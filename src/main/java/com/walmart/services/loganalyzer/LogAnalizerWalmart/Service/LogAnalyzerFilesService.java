...
@Service
public class LogAnalyzerFilesService {
    private  static final Logger  LOGGER = LoggerFactory.getLogger(LogAnalyzerFilesService.class);
    @Value("${log.file.directory}")
    private String logFileDirectory;

    public List<String> findByDateAndKeyword (LogFileSearchRequest logFileSearchRequest) throws IOException{
    ...
    public List<String> findByKeyword (LogFileSearchRequest logFileSearchRequest) throws IOException {
    ...
    public List<String> findByDate (LogFileSearchRequest logFileSearchRequest) throws IOException {
